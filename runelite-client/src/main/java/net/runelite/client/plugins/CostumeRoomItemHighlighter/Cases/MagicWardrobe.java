...
public class MagicWardrobe {
	...
	{
		this.MagicWardrobeHash = new HashSet<>();
		...
		this.MagicWardrobeHash.add(ItemID.GHOSTLY_ROBE); // Ghostly robe top
		this.MagicWardrobeHash.add(ItemID.GHOSTLY_ROBE_6108); // Ghostly robe bottom
		...
		// Regular Graceful Outfit when worn
		this.MagicWardrobeHash.add(ItemID.GRACEFUL_HOOD_11851); // Worn
		this.MagicWardrobeHash.add(ItemID.GRACEFUL_TOP_11855); // Worn
		...
		// Adventurer Graceful Outfit when worn
		...
		// Agility Arena Graceful Outfit when worn
		...
		// Arceuus Graceful Outfit when worn
		...
		// Hallowed Graceful Outfit when worn
		...
		// Hosidius Graceful Outfit when worn
		...
		// Kourend Graceful Outfit when worn
		...
		// Lovakengj Graceful Outfit when worn
		...
		// Piscarilius Graceful Outfit when worn
		...
		// Shayzien Graceful Outfit when worn
		...
		// Trailblazer Graceful Outfit when worn
		...
		this.MagicWardrobeHash.add(ItemID.INFINITY_GLOVES); // cannot be recolored
		this.MagicWardrobeHash.add(ItemID.INFINITY_BOOTS); // cannot be recolored
		...
		this.MagicWardrobeHash.add(ItemID.BOOTS_OF_THE_EYE); // Boots cannot be recolored
